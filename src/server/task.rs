...
pub enum ClientTaskHolder {
    ...
    Opaque(ClientTaskSpec<SerializedMemory>),
}
...
impl Task {
    ...
    pub fn make_compute_task_msg(
        ...
        match &self.spec {
            ...
            Some(ClientTaskHolder::Opaque(spec)) => match spec {
                ClientTaskSpec::Direct(DirectTaskSpec {
                    ...
                    msg_args = args.as_ref().map(|v| v.to_transport_clone(mbuilder)).map(TaskArgument::Object);
